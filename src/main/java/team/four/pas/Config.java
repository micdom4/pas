...
import team.four.pas.repositories.LocalAllocationRepository;
...
public class Config {
    ...
    @Bean
    public LocalAllocationRepository localAllocationRepository(){
        var localAllocationRepository = new LocalAllocationRepository();
