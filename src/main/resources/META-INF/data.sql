...
INSERT INTO orders (orderId, client_id, worker_id, price, startTime, endTime, active, destination) VALUES (1001, 1, 201, 49.99, '2025-10-09 12:00:00', '2025-10-09 12:45:00', TRUE, 'Central Park');
INSERT INTO food_order (orderId, restaurant_id, restaurantAddress) VALUES (1001, 501, '123 Main St');

INSERT INTO orders (orderId, client_id, worker_id, price, startTime, endTime, active, destination) VALUES (1004, 2, 202, 29.99, '2025-10-09 10:00:00', '2025-10-09 10:30:00', TRUE, 'Times Square');
INSERT INTO food_order (orderId, restaurant_id, restaurantAddress) VALUES (1004, 502, '456 Elm St');

INSERT INTO orders (orderId, client_id, worker_id, price, startTime, endTime, active, destination) VALUES (1005, 3, 203, 34.50, '2025-10-09 18:15:00', '2025-10-09 18:45:00', FALSE, 'Brooklyn Bridge');
INSERT INTO food_order (orderId, restaurant_id, restaurantAddress) VALUES (1005, 503, '789 Maple Ave');

-- Orders and Taxi Orders
INSERT INTO orders (orderId, client_id, worker_id, price, startTime, endTime, active, destination) VALUES (1003, 1, 401, 79.00, '2025-10-09 14:00:00', '2025-10-09 14:30:00', FALSE, 'Downtown Plaza');
INSERT INTO taxi_order (orderId, type, startLocation, licensePlate) VALUES (1003, 'PREMIUM', 'North Square', 'ABC-1234');

INSERT INTO orders (orderId, client_id, worker_id, price, startTime, endTime, active, destination) VALUES (1008, 5, 402, 59.00, '2025-10-09 11:30:00', '2025-10-09 12:05:00', TRUE, 'Union Station');
INSERT INTO taxi_order (orderId, type, startLocation, licensePlate) VALUES (1008, 'COMFORT', 'East Village', 'XYZ-9876');

INSERT INTO orders (orderId, client_id, worker_id, price, startTime, endTime, active, destination) VALUES (1009, 3, 403, 99.00, '2025-10-09 19:00:00', '2025-10-09 19:40:00', TRUE, 'Airport Terminal B');
INSERT INTO taxi_order (orderId, type, startLocation, licensePlate) VALUES (1009, 'PREMIUM', 'City Hall', 'JKL-5678');

INSERT INTO orders (orderId, client_id, worker_id, price, startTime, endTime, active, destination) VALUES (1010, 4, 404, 45.00, '2025-10-09 08:30:00', '2025-10-09 09:00:00', FALSE, 'SoHo');
